...
self.addEventListener('fetch',e=>{
  ...
  if(u.pathname.endsWith('/index.html')||u.pathname.endsWith('/app.js')||u.pathname.endsWith('/config.js')||u.pathname.endsWith('/strategy.js')||u.pathname.endsWith('/sw.js')){
