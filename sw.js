const CACHE='kamo-life-v3';
const ASSETS=['./','./index.html','./style.css','./app.js','./config.js','./manifest.json','./icon.svg','./admin.html','./admin.js'];
...
self.addEventListener('fetch',e=>{
  ...
  if(u.pathname.endsWith('/app.js')||u.pathname.endsWith('/config.js')||u.pathname.endsWith('/sw.js')){
